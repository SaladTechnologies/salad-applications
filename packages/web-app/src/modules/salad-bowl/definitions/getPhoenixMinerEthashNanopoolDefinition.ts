...
export const getPhoenixMinerEthashNanopoolDefinition = (machine: Machine): PluginDefinition => {
  let def = {
    ...
    args: `-rvram 1 -pool eth-us-east1.nanopool.org:9999 -pool2 eth-eu1.nanopool.org:9999 -ewal ${ETH_WALLET_ADDRESS} -epsw x -eworker ${machine.id} -allpools 1 -allcoins 0`,
