...
export const getPreppingPercentage = (runningTime?: number): number => {
  if (runningTime) {
    const buckets = [
      ...
      { startAt: 1500000, percentage: 0.03 }, // startsAt 25 Minutes
      { startAt: 1200000, percentage: 0.06 }, // startsAt 20 Minutes
      { startAt: 900000, percentage: 0.12 }, // startsAt 15 Minutes
      { startAt: 600000, percentage: 0.12 }, // startsAt 10 Minutes
      { startAt: 300000, percentage: 0.3 }, // startsAt 5 Minutes
      { startAt: 60000, percentage: 0.12 }, // startsAt 1 Minute
      { startAt: 30000, percentage: 0.06 }, // startsAt 30 Seconds
      { startAt: 10000, percentage: 0.05 }, // startsAt 10 Seconds
      { startAt: 0, percentage: 0.1 },
    ]
