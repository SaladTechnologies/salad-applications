    ...
    return (
      <div style={{ position: 'absolute', zIndex: 3000, top: 0, right: 0, bottom: 0, left: 0 }}>
        <OnboardingPage
          ...
          onNext={onNext}
          nextText={'Close'}
          childContainerPaddingBottom={'2rem'}
        >
          <Scrollbar>
            ...
            <div className={classes.body}>
              ...
              <p>
                your hard coded earning rate will be displayed.If you don't have an active earning rate, your balance
                will not tick up.
              </p>
            </div>
            <div className={classes.title}>4. Auto-Launch</div>
            <div className={classes.body}>
              After login Salad will automatically open. You can turn this feature off in settings.
            </div>
          </Scrollbar>
        </OnboardingPage>
      </div>
