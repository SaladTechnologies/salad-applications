...
const firewallBody =
'<ol><li> Open Windows Security.<img src="https://support.salad.io/hc/article_attachments/360089893631/mceclip0.png" alt="mceclip0.png"></li><li>Navigate to Firewall &amp; network protection.<img src="https://support.salad.io/hc/article_attachments/360090201211/FIREWALL_GUIDE_IMAGE_2.png" alt="FIREWALL_GUIDE_IMAGE_2.png"></li><li>Scroll down to Allow an app through firewall.<img src="https://support.salad.io/hc/article_attachments/360090201191/FIREWALLGUIDE_IMAGE_3.png" alt="FIREWALLGUIDE_IMAGE_3.png"></li><li>Scroll down until you find the affected miner.<img src="https://support.salad.io/hc/article_attachments/360090201271/FIREWALL_GUIDE_IMAGE_4.png" alt="FIREWALL_GUIDE_IMAGE_4.png"></li><li>Click Change settings at the top right, and click all the tick boxes on the right side, as well as left side, of the affected miner. Do the same for any further firewall blocked affected miners, if you see the same item listed multiple times, make sure to allow all of them through. Then click OK.</li></ol><p> </p><p>If you are using another Firewall service, please consult their website or support for details on how to allow applications or services through your Firewall.</p>'
