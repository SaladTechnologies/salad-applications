...
const mapStoreToProps = (store: RootStore): any => ({
  ...
  whitelistWindowsDefenderError: store.onboarding.whitelistWindowsDefenderError,
  whitelistWindowsDefenderPending: store.onboarding.whitelistWindowsDefenderPending,
  whitelistWindowsDefenderErrorType: store.onboarding.whitelistWindowsDefenderErrorType,
