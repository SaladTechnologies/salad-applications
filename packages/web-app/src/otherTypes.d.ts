...
declare module '@elastic/search-ui-app-search-connector' {
  class AppSearchAPIConnector {
    constructor({
      ...
      beforeSearchCall?: (queryOptions: object, next: (updatedQueryOptions: object) => object) => any
      beforeAutocompleteResultsCall?: (queryOptions: object, next: (updatedQueryOptions: object) => object) => any
      beforeAutocompleteSuggestionsCall?: (queryOptions: object, next: (updatedQueryOptions: object) => object) => any
      endpointBase?: string
    })
  }
...
declare module '@elastic/react-search-ui' {
  export function withSearch(props: (context: Context) => any): any
